...
class AutomationWindow(tk.Toplevel):
    ...
    def set_automation_folder(self):
        self.automation_folder = filedialog.askdirectory(title="Select Automation Folder")
        if self.automation_folder:
            # Update database
    ...
    def go_to_parent_directory(self):
        if self.current_dir == self.automation_folder:
            messagebox.showinfo("Info", "Already in the root directory.")
            return
