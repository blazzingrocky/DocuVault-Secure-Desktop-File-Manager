...
class Dashboard:
    def __init__(self, parent):
        ...
        self.dashboard_window.geometry("800x900") # Reduced from 1000x700
    ...
    def select_directory(self):
        ...
        dest_dialog = CustomDirectoryDialog(self.parent.root, self.parent.current_dir)
        self.parent.root.wait_window(dest_dialog)
        if dest_dialog.selected_path:
            self.go_to_directory(dest_dialog.selected_path)
