...
# Import the FileManager class from newfilemanager2.py
from newfilemanager2 import FileManager
...
class TestFileManager(unittest.TestCase):
    ...
    def test_delete_item_to_bin(self):
        ...
        with patch('newfilemanager2.allow_access'), patch('newfilemanager2.restrict_access'):
    ...
    #     """Test opening a file."""
    #     # Mock subprocess.Popen to avoid actually opening the file
    #     with patch('newfilemanager2.subprocess.Popen') as mock_popen:
    ...
    def test_open_file(self):
        ...
        with patch('newfilemanager2.subprocess.Popen', side_effect=side_effect) as mock_popen:
            success, message = self.file_manager.open_file(self.test_file)
