...
class AutomationWindow(tk.Toplevel):
    ...
    def create_widgets(self):
        ...
        buttons = [
            ...
            ("Move to Automation folder", self.move_to_auto_folder),
            ("Copy to Automation folder", self.copy_to_auto_folder),
            ("FullScreen", lambda: self.parent.attributes('-fullscreen', True))
        ]
