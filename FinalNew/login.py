...
class LoginPage(tk.Tk):
    def __init__(self):
        ...
        try:
            self.iconbitmap("AppIcon\\Docu-icon.ico")
        except:
            pass
    ...
    def login_submit(self):
        ...
        if login_result is None:
            ...
            # app.root.iconbitmap("AppIcon\\DocuVault-icon.ico")
            app.run()
        else:
    ...
    def register_user(self):
        ...
        if setup_automation:
            automation_folder = os.path.join(os.path.expanduser("~"), f"Automation_Window_{username}")
